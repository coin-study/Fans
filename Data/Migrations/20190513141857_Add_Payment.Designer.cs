...
namespace fans.Data.Migrations
{
    ...
    [Migration("20190513141857_Add_Payment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("fans.EntityModels.Member", b =>
                {
                    ...
                    b.Property<string>("KatakanaFirstName");

                    b.Property<string>("KatakanaLastName");
            ...
            modelBuilder.Entity("fans.EntityModels.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("PaymentConfirm");

                    b.Property<string>("PaymentCustomer");
            ...
            modelBuilder.Entity("fans.EntityModels.Payment", b =>
                {
                    b.HasOne("fans.EntityModels.Member", "Member")
                        .WithOne("Payment")
                        .HasForeignKey("fans.EntityModels.Payment", "MemberId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
